...
class AppAssets {
  ...
  static const String workAllocation = '$basePath/work_allocation'; //folder base path
  static const String workAllocationSvgs = '$svgsPath/work_allocation'; //folder svgs path
  static const String stepper = '$basePath/stepper';


  // Svgs Take Order
  /*static const String offers = '$svgsTakeOrder/offers.svg';*/ //demo
